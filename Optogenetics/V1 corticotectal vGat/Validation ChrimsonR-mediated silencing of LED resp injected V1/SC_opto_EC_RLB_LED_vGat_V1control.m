%% SC_opto_EC_RLB_LED_vGat_V1control
% Analyse spike responses to LED stimulation to Right Left and Both eyes in
% mice that have been injected with ChrimsonR in left V1. Recordings from
% left V1 neurons to confirm silencing of visual responses
...
%% 210427_2
P.datapath = [path to files] '210427';
P.fileNums = [8];
P.sweepExclude = [];
P.fileNamePrefix = '27Apr21 ';
P.cellID = '210427_2';
...
P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
P.yyaxis_lim = [50]; % yyaxis limit for the PSTH plots
P.peakamp_XwindowLim = 0.3; % Define the outer limit used for calculating the amplitude of reponse; 

%% 210520_1
P.datapath = [path to files] '210520';
P.fileNums = [1];
P.sweepExclude = [];
P.fileNamePrefix = '20May21 ';
P.cellID = '210520_1';
...
P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
P.yyaxis_lim = [50]; % yyaxis limit for the PSTH plots
P.peakamp_XwindowLim = 0.16; % Define the outer limit used for calculating the amplitude of reponse; 
...
P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
P.yyaxis_lim = [50]; % yyaxis limit for the PSTH plots
P.peakamp_XwindowLim = 0.165; % Define the outer limit used for calculating the amplitude of reponse; 
...
P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
P.yyaxis_lim = [50]; % yyaxis limit for the PSTH plots
P.peakamp_XwindowLim = 0.175; % Define the outer limit used for calculating the amplitude of reponse;
...
figure(fig(5));
figname = sprintf('PSTH_RL_vgatDoubleInj_V1control_%s.fig',P.fileName);
saveas(gcf,figname,'fig');
figname = sprintf('PSTH_RL_vgatDoubleInj_V1control_%s.pdf',P.fileName);
print('-dpdf','-painters','-loose','-fillpage',figname);
figure(fig(6));
figname = sprintf('KDE_RL_vgatDoubleInj_V1control_%s.fig',P.fileName);
saveas(gcf,figname,'fig');
figname = sprintf('KDE_RL_vgatDoubleInj_V1control_%s.pdf',P.fileName);
print('-dpdf','-painters','-loose','-fillpage',figname);

savename = sprintf('RL_vgatDoubleInj_V1control_%s.mat',P.fileName)
