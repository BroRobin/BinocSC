%% SC_opto_EC_RLB_LED_vGat_SC
% Analyse spike responses to LED stimulation of Right Left and Both eyes,
% with in alternating trials ChR2-mediated silencing of vGat neurons in the
% opposite SC
...
for counter = 1:27
    ...
    if counter ==1
        %% 210309_1
        P.datapath = [path to files] '210309';
        P.fileNums = [2];
        P.sweepExclude = [];
        P.fileNamePrefix = '09March21 ';
        P.cellID = '210309_1';
        P.pksThreshold = -0.16; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = [100]; % yyaxis limit for the PSTH plots
    ...
    elseif counter ==5
        %% 210310_1
        P.datapath = [path to files] '210310';
        P.fileNums = [2];
        P.sweepExclude = [];
        P.fileNamePrefix = '10Mar21 ';
        P.cellID = '210310_1';
    ...
    elseif counter ==7
        ...
        P.fileNamePrefix = '10Mar21 ';
        P.cellID = '210310_3';
        P.pksThreshold = -0.022; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
    ...
    elseif counter ==13
        %% 211109_1
        P.datapath = [path to files] '211109';
        P.fileNums = [2];
        P.sweepExclude = [];
        P.fileNamePrefix = '09Nov21 ';
        P.cellID = '211109_1';
    ...
    elseif counter ==16
        % 211103_1
        P.datapath = [path to files] '211103';
        P.fileNums = [1];
        P.sweepExclude = [];
        P.fileNamePrefix = '03Nov21 ';
        P.cellID = '211103_1';
        P.pksThreshold = -0.05; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 7;
    ...
    elseif counter ==17
        ...
        P.fileNamePrefix = '09Nov21 ';
        P.cellID = '211109_4';
        P.pksThreshold = -0.005; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 7;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
    ...
    elseif counter ==18
        %% 21110_1
        P.datapath = [path to files] '211110';
        P.fileNums = [2];
        P.sweepExclude = [];
        P.fileNamePrefix = '10Nov21 ';
        P.cellID = '211110_1';
        P.pksThreshold = -0.1; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50;
    ...
    elseif counter ==20
        ...
        P.fileNamePrefix = '10Nov21 ';
        P.cellID = '211110_3';
        P.pksThreshold = -0.23; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 71;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
    ...
    elseif counter ==22
        %% 211206_1
        P.datapath = [path to files] '211206';
        P.fileNums = [3];
        P.sweepExclude = [];
        P.fileNamePrefix = '06Dec21 ';
        P.cellID = '211206_1';
        P.pksThreshold = -0.02; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50;
    ...
    elseif counter ==25
        %% 211216_1
        P.datapath = [path to files] '211216';
        P.fileNums = [1];
        P.sweepExclude = [];
        P.fileNamePrefix = '16Dec21 ';
        P.cellID = '211216_1';
        P.pksThreshold = -0.02; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50;
    ...
    elseif counter ==27
        ...
        P.fileNamePrefix = '16Dec21 ';
        P.cellID = '211216_3';
        P.pksThreshold = -0.013; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
    ...
    try
        ...
        elseif sum(P.cellID == '210210_2')==8
            D.extended = load('210210_2_file5.mat');
            D.stimData = [D.stimData; D.extended.D.stimData];
        elseif sum(P.cellID == '210217_2')==8
            D.extended = load('17Feb21_002(output).mat');
            D.stimData = [D.stimData; D.extended.D.stimData];
        elseif sum(P.cellID == '211110_3')==8
            D.extended = load('20Nov21_006(output).mat');
            D.stimData = [D.stimData; D.extended.D.stimData];
        end
    end
    ...
    for ii = 1:length(D.trialID)
        ...
        if D.trialID(ii)==1
            ...
            try
                if sum(P.cellID == '210310_1')==8
                    Spk.spktimes_leftOpto{count_leftOpto}(Spk.spktimes_leftOpto{count_leftOpto}>0.0004&Spk.spktimes_leftOpto{count_leftOpto}<0.0007)=[];
                end
            end
    ...
    Spkstats.peakamp_sum_ON=max(Spk.kde_sum(Spk.kde_both_X>0&Spk.kde_both_X<P.peakamp_XwindowLim));
    Spkstats.peakamp_sum_ON_opto=max(Spk.kde_sumOpto(Spk.kde_bothOpto_X>0.02&Spk.kde_bothOpto_X<P.peakamp_XwindowLim));
    ...
    Spkstats.outputVars = [Spont.FF, Spont.ISI_stats(1,1), Spont.ISI_stats(1,2),Spont.CV...
        ,Spkstats.peakamp_contra_ON, Spkstats.peakamp_ipsi_ON, Spkstats.peakamp_both_ON, Spkstats.peakamp_sum_ON...
        ,Spkstats.peakamp_contra_ON_opto, Spkstats.peakamp_ipsi_ON_opto, Spkstats.peakamp_both_ON_opto, Spkstats.peakamp_sum_ON_opto...
    ...
    figure(fig(5));
    figname = sprintf('PSTH_opto_VGATcre_SC_RLB_%s.fig',P.fileName);
    saveas(gcf,figname,'fig');
    figname = sprintf('PSTH_opto_VGATcre_SC_RLB_%s.pdf',P.fileName);
    print('-dpdf','-painters','-loose','-fillpage',figname);
    figure(fig(6));
    figname = sprintf('KDE_opto_VGATcre_SC_tRLB_%s.fig',P.fileName);
    saveas(gcf,figname,'fig');
    figname = sprintf('KDE_opto_VGATcre_SC_RLB_%s.pdf',P.fileName);
    print('-dpdf','-painters','-loose','-fillpage',figname);

    savename = sprintf('RLB_EC_opto_VGATcre_SC_%s.mat',P.fileName)
