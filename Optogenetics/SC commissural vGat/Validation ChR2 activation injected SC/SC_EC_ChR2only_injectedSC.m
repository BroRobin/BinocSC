%% SC_EC_ChR2only_injectedSC
% Analyse spike responses to ChR2 activation in the injected SC
...
for kk=1:30
    ...
    elseif kk==2
        ...
        P.fileNamePrefix = '19Aug20 ';
        P.cellID = '200819_2';
        P.pksThreshold = -0.00625; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
    ...
    elseif kk==8
        ...
        P.fileNamePrefix = '19Aug20 ';
        P.cellID = '200819_8';
        P.pksThreshold = -0.007; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30;
        P.wavelength = 470;
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
    ...
    elseif kk==18
        %% 200821_2
        P.datapath = [path to files] '200821';
        P.fileNums = [3];
        P.sweepExclude = [];
        P.fileNamePrefix = '21Aug20 ';
        P.cellID = '200821_2';
