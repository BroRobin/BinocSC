%% SC_OptoOnly_OppositeSC_100ms_1500umfiber_cellsafter200827
...
for kk=1:41
    ...
    elseif kk==40
        ...
        P.fileNamePrefix = '09Sep20 ';
        P.cellID = '200909_23';
        P.pksThreshold = -0.11; % intracellular diff
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30;P.wavelength = 470;
        P.sensorCorrection=0; % Reduce the TTL starttimes with 14.9ms to correct for position of the sensor
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform.
    ...
    for xx=1:length(P.fileNums)
        ...
        Spkstats.outputVars = [Spkstats.opto_resp_3 Spkstats.peakamp Spkstats.latency_opto Spont.FF];
