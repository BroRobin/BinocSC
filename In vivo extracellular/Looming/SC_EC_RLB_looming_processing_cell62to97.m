...
for kk=11:36
    ...
    if save_plot_data==1
        ...
        elseif P.side ==1;
            if kk==11;
                plot(Spk.kde_right_X,Spk.kde_right,'b','LineWidth',2); ylim([0 max([Spk.kde_right Spk.kde_left Spk.kde_both])]); ylabel('FF (Hz)')
            else
