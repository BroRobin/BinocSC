%% SC_EC_RLB_looming
% Analyse Vm and spike responses to gratings to Right Left and Both eyes
...
% Import the data
file1 = load('13Aug20_002.mat');
file2 = load('13Aug20_003.mat');
...
% P.rightScreenProps.locs(201)=[];
% P.leftScreenProps.locs(201)=[];
% P.rightScreenProps.locs(101)=[];
% P.leftScreenProps.locs(101)=[];
...
% Not reliable CV2 value
%     Spont.CV2_list=[];
%     for i=1:size(Spont.ISI,2)-1
%         Spont.CV2_list(i) = (2*abs(Spont.ISI(i+1)-Spont.ISI(i)))/(Spont.ISI(i+1)+Spont.ISI(i));
%     end
%     Spont.CV2 = nanmean(Spont.CV2_list);
